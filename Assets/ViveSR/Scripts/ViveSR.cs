...
namespace Vive.Plugin.SR
{
    public class ViveSR : MonoBehaviour
    {
        ...
        */
        ...
        private int PreviousRuntimeStatus = 0;
        ...
        public void RuntimeStatusHandler(int status)
        {
            ...
            foreach (var flag in changedFlags)
            {
                ...
                // If a plugout flag becomes 1, quit the application.
                if ((flag == (int)RuntimeStatusFlag.HMD_IS_PLUGOUT || flag == (int)RuntimeStatusFlag.COVER_IS_PLUGOUT) && flagValue)
                {
                    Application.Quit();
                }
        ...
        private void UpdateWhileWorking()
        {
            ...
            if (InitializePassThroughModule == true && InitializeAISceneModule == true)
            {
                SRWorkModule_API.TurnOffUndistortDataToDepth();
